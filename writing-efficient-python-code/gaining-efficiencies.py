...
def gathering_pokemon_without_a_loop():
...
def main():
    # comparing_pokedexes()
    # searching_for_pokemon()
    # gathering_unique_pokemon()
    # gathering_pokemon_without_a_loop()
    # gathering_pokemon_without_a_loop()
    # one_time_calculation_loop()
    # holistic_conversion_loop()
